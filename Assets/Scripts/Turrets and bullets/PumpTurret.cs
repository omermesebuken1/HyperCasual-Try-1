...
public class PumpTurret : MonoBehaviour
{
   ...
   private float randompump1;
   private float randompump2;
   private float randompump3;
   private float randompump4;
   private float randompump5;
   ...
   private void TurretShot() // ateş etme
   {
    ...
    if(timer >= bulletCooldown && fire && distanceOK)
    {
        ...
        randompump1 = Random.Range(-120,-60);
        randompump2 = Random.Range(-120,-60);
        randompump3 = Random.Range(-120,-60);
        randompump4 = Random.Range(-120,-60);
        randompump5 = Random.Range(-120,-60);

        Instantiate(pumpSound);
        Instantiate(bullet,bulletPoint.transform.position,childrenTurret.transform.rotation*Quaternion.Euler(randompump1,90,0));
        Instantiate(bullet,bulletPoint.transform.position + new Vector3(0.3f,0,0),childrenTurret.transform.rotation*Quaternion.Euler(randompump2,90,0));
        Instantiate(bullet,bulletPoint.transform.position + new Vector3(-0.3f,0,0),childrenTurret.transform.rotation*Quaternion.Euler(randompump3,90,0));
        Instantiate(bullet,bulletPoint.transform.position + new Vector3(0,0.3f,0),childrenTurret.transform.rotation*Quaternion.Euler(randompump4,90,0));
        Instantiate(bullet,bulletPoint.transform.position + new Vector3(0,-0.3f,0),childrenTurret.transform.rotation*Quaternion.Euler(randompump5,90,0));
        timer = 0;
